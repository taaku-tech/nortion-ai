...
`vercel.json` に以下が設定されており、毎日 3:00 UTC に自動実行されます:

```json
{
  "crons": [{ "path": "/api/cron/extract", "schedule": "0 3 * * *" }]
}
```
...
curl -H "Authorization: Bearer $CRON_SECRET" \
  https://<your-project>.vercel.app/api/cron/extract

# ブラウザ・URL確認用
curl "https://<your-project>.vercel.app/api/cron/extract?secret=$CRON_SECRET"
```
